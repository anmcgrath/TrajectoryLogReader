...
public class MLCLeafRecord
{
    ...
    internal MLCLeafRecord(TrajectoryLog log, int measIndex, int bankIndex, int leafIndex, AxisScale? targetScale = null)
    {
        _log = log;
    ...
    public MLCLeafRecord WithScale(AxisScale scale)
    {
