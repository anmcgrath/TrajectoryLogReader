...
#endif
    public static double GetIntersectionArea(AABB clipRect, ReadOnlySpan<Point2d> subjectPoly)
    {
        ...
        Span<Point2d> buffer1 = stackalloc Point2d[maxVertices];
        Span<Point2d> buffer2 = stackalloc Point2d[maxVertices];
            ...
            for (int i = 0; i < inputCount; i++)
            {
                ...
                if (isCurrIn)
                {
                    if (!isPrevIn) // Out -> In: Add Intersection
                    {
                        ...
                        buffer2[outputCount++] = new Point2d(clipRect.MinX, prev.Y + t * (curr.Y - prev.Y));
                    }
            ...
            for (int i = 0; i < inputCount; i++)
            {
                ...
                if (isCurrIn)
                {
                    if (!isPrevIn)
                    {
                        ...
                        buffer1[outputCount++] = new Point2d(clipRect.MaxX, prev.Y + t * (curr.Y - prev.Y));
                    }
            ...
            for (int i = 0; i < inputCount; i++)
            {
                ...
                if (isCurrIn)
                {
                    if (!isPrevIn)
                    {
                        ...
                        buffer2[outputCount++] = new Point2d(prev.X + t * (curr.X - prev.X), clipRect.MinY);
                    }
            ...
            for (int i = 0; i < inputCount; i++)
            {
                ...
                if (isCurrIn)
                {
                    if (!isPrevIn)
                    {
                        ...
                        buffer1[outputCount++] = new Point2d(prev.X + t * (curr.X - prev.X), clipRect.MaxY);
                    }
...
#endif
    public static double GetIntersectionAreaPixel(int col, int row, ReadOnlySpan<Point2d> subjectPoly)
    {
        // Pixel bounds
        double minX = col;
        double maxX = col + 1;
            ...
            for (int i = 0; i < inputCount; i++)
            {
                ...
                if (isCurrIn)
                {
                    if (!isPrevIn)
                    {
                        ...
                        buffer2[outputCount++] = new Point2d(minX, prev.Y + t * (curr.Y - prev.Y));
                    }
            ...
            for (int i = 0; i < inputCount; i++)
            {
                ...
                if (isCurrIn)
                {
                    if (!isPrevIn)
                    {
                        ...
                        buffer1[outputCount++] = new Point2d(maxX, prev.Y + t * (curr.Y - prev.Y));
                    }
            ...
            for (int i = 0; i < inputCount; i++)
            {
                ...
                if (isCurrIn)
                {
                    if (!isPrevIn)
                    {
                        ...
                        buffer2[outputCount++] = new Point2d(prev.X + t * (curr.X - prev.X), minY);
                    }
            ...
            for (int i = 0; i < inputCount; i++)
            {
                ...
                if (isCurrIn)
                {
                    if (!isPrevIn)
                    {
                        ...
                        buffer1[outputCount++] = new Point2d(prev.X + t * (curr.X - prev.X), maxY);
                    }
