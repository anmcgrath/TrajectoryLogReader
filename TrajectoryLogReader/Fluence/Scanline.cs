...
internal class Scanline
{
    public static void ProcessScanlines(
        ReadOnlySpan<Point> corners, // The 4 corners from previous step
        ...
        Action<int, double, double> onScanline) // Callback: (y, startX, endX)
    {
        ...
        // Left Side
        Point vLeftTop = corners[topIdx];
        Point vLeftBot = corners[leftIdx];
        var leftSlope = (vLeftBot.X - vLeftTop.X) / (vLeftBot.Y - vLeftTop.Y);
        var currentLeftX = vLeftTop.X;

        // Right Side
        Point vRightTop = corners[topIdx];
        Point vRightBot = corners[rightIdx];
        ...
        Action<int, double, double> callback)
    {
        ...
        // Setup Left Edge
        Point vL1 = corners[topIdx];
        Point vL2 = corners[leftIdx];
        ...
        // Setup Right Edge
        Point vR1 = corners[topIdx];
        Point vR2 = corners[rightIdx];
