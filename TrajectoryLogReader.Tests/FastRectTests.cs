...
public class FastRectTests
{
    ...
    public void GetRotatedRectAndBounds_NoRotation_ReturnsCorrectCornersAndBounds()
    {
        ...
        */
        ...
        corners[0].ShouldBe(new Point(12, 9));
        corners[1].ShouldBe(new Point(12, 11));
        corners[2].ShouldBe(new Point(8, 11));
        corners[3].ShouldBe(new Point(8, 9));
    ...
    public void GetRotatedRectAndBounds_90DegRotation_ReturnsSwappedDims()
    {
        ...
        corners[0].ShouldBe(new Point(1, 2));
        corners[1].ShouldBe(new Point(-1, 2));
        corners[2].ShouldBe(new Point(-1, -2));
        corners[3].ShouldBe(new Point(1, -2));
